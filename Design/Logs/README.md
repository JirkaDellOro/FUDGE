...
Also talked and re-capped the Jobs the FUDGE UI need to do, as well as discussing a rough design for how Gizmos should be handled internally in the FUDGE Core and how a KeyManager could function for FUDGE ([2](https://github.com/JirkaDellOro/FUDGE/blob/master/Design/Logs/190718_ViewportEditor_Keymanager_FUDGEUI.txt))([3](https://github.com/JirkaDellOro/FUDGE/blob/master/Design/Logs/190718_Whiteboard.JPG))
