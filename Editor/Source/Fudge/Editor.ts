namespace Fudge {
    ...
    export class UINodeList {
        ...
        constructor(_node: ƒ.Node, _listContainer: HTMLElement) {
            ...
            _listContainer.addEventListener(ƒui.UIEVENT.COLLAPSE, this.toggleCollapse);
    ...
    export class UIAnimationList {
        ...
        constructor(_mutator: ƒ.Mutator, _listContainer: HTMLElement) {
            ...
            _listContainer.addEventListener(ƒui.UIEVENT.COLLAPSE, this.toggleCollapse);
            _listContainer.addEventListener(ƒui.UIEVENT.UPDATE, this.collectMutator);
        }
    ...
    export class UINodeData extends ƒui.UIMutable {
        public constructor(_mutable: ƒ.Mutable, _container: HTMLElement) {
            super(_mutable);
            this.root = document.createElement("form");
            ƒui.UIGenerator.createFromMutable(<ƒ.Mutable>_mutable, this.root);
