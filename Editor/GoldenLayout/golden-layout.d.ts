...
/** @public */
 declare class BindError extends ExternalError {
    /* Excluded from this release type: __constructor */
}
...
/** @public */
 declare class GoldenLayout extends VirtualLayout {
...
/** @public */
 declare type LogicalZIndex = 'base' | 'drag' | 'stackMaximised';

/** @public */
 declare namespace LogicalZIndex {
    const base = "base";
    const drag = "drag";
...
/** @public */
 declare namespace StyleConstants {
...
/** @public */
 declare class VirtualLayout extends LayoutManager {
...
/** @public */
 declare namespace VirtualLayout {
    /**
