...
(function (Fudge) {
    ...
    class Files extends ƒ.Mutable {
        index = new FileInfo(true, "");
        style = new FileInfo(true, "");
        internal = new FileInfo(true, "");
        script = new FileInfo(true, "");
        constructor() {
            super();
...
(function (Fudge) {
    ...
    class Page {
        static idCounter = 0;
        static goldenLayoutModule = globalThis.goldenLayout;
        static goldenLayout;
        static panels = [];
        static async start() {
        ...
        static setupGoldenLayout() {
            ...
            this.goldenLayout.registerComponentConstructor(Fudge.PANEL.PROJECT, Fudge.PanelProject);
            this.goldenLayout.registerComponentConstructor(Fudge.PANEL.GRAPH, Fudge.PanelGraph);
        ...
        static add(_panel, _title, _state) {
            ...
            this.goldenLayout.rootItem.layoutManager.addItemAtLocation(panelConfig, [{ typeId: 7 /* Root */ }]);
