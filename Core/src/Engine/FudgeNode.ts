namespace Fudge {
    export interface StringToFudgeNode {
    ...
    export class FudgeNode {
        ...
        private children: StringToFudgeNode; // Associative array nodes appended to this node.
         ...
         */
        public getChildren(): StringToFudgeNode {
