namespace FudgeCore {
  /**
    ...
    */
  export class PhysicsQuaternion extends Mutable {
    #x: number;
    #y: number;
    #z: number;
    #w: number;
    ...
    public multiply(_other: PhysicsQuaternion, _fromLeft: boolean = false): void {
      const a: PhysicsQuaternion = _fromLeft ? _other : this;
      const b: PhysicsQuaternion = _fromLeft ? this : _other;
      const x: number = a.x * b.x - a.y * b.y - a.z * b.z - a.w * b.w;
      const y: number = a.x * b.y + a.y * b.x + a.z * b.w - a.w * b.z;
      const z: number = a.x * b.z - a.y * b.w + a.z * b.x + a.w * b.y;
      const w: number = a.x * b.w + a.y * b.z - a.z * b.y + a.w * b.x;
      this.x = x;
      this.y = y;
      this.z = z;
      this.w = w;
