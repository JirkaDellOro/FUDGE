  ...
  export class MeshBroom extends MeshMutable {
    ...
    public create(_headLength: number, _headWidth: number,_shaftLength: number): void {
        ...
        this.vertices = new Vertices(
          ...
          new Vertex(new Vector3(-0.029871, -0.798685 - (_shaftLength/2), 0.034611), new Vector2(0.375000, 0.625000)),
          new Vertex(new Vector3(-0.029871, -0.798685 - (_shaftLength/2), -0.024738), new Vector2(0.375000, 0.000000)),
          new Vertex(new Vector3(0.029478, -0.798685 - (_shaftLength/2), 0.034611), new Vector2(0.125000, 0.750000)),
          new Vertex(new Vector3(0.029478, -0.798685 - (_shaftLength/2), -0.024738), new Vector2(0.375000, 1.000000)),
          new Vertex(new Vector3(-0.000196, -0.798685 - (_shaftLength/2), -0.039576), new Vector2(0.125000, 0.500000)),
          new Vertex(new Vector3(-0.000196, -0.798685 - (_shaftLength/2), 0.049448), new Vector2(0.375000, 0.250000)),
          new Vertex(new Vector3(-0.044708, -0.798685 - (_shaftLength/2), 0.004936), new Vector2(0.375000, 0.750000)),
          new Vertex(new Vector3(0.044316, -0.798685 - (_shaftLength/2), 0.004936), new Vector2(0.375000, 0.500000)),
          new Vertex(new Vector3(-0.000196, -0.824413 - (_shaftLength/2), 0.004936), new Vector2(0.250000, 0.500000)),
          new Vertex(new Vector3(-0.508497 - (_headLength/2), 0.428565, 0.064658 + (_headWidth/2)), new Vector2(0.375000, 0.375000)),
          new Vertex(new Vector3(-0.508497 - (_headLength/2), 0.517779, 0.064658 + (_headWidth/2)) , new Vector2(0.250000, 0.750000)),
          new Vertex(new Vector3(-0.508497 - (_headLength/2), 0.428565, -0.054786 - (_headWidth/2)), new Vector2(0.375000, 0.875000)),
          new Vertex(new Vector3(-0.508497 - (_headLength/2), 0.517779, -0.116488 - (_headWidth/2)), new Vector2(0.125000, 0.625000)),
          new Vertex(new Vector3(0.509331 + (_headLength/2), 0.428565, 0.064658 + (_headWidth/2)), new Vector2(0.375000, 0.125000)),
          new Vertex(new Vector3(0.509331 + (_headLength/2), 0.517779, 0.064658 + (_headWidth/2)), new Vector2(0.375000, 0.625000)),
          new Vertex(new Vector3(0.509331 + (_headLength/2), 0.428565, -0.054786 - (_headWidth/2)), new Vector2(0.250000, 0.625000)),
          new Vertex(new Vector3(0.509331 + (_headLength/2), 0.517779, -0.116488 - (_headWidth/2)), new Vector2(0.375000, 0.000000))
