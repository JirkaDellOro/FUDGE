namespace FudgeCore {  
  ...
  export class MeshSword extends MeshMutable {    
    ...
    public create(_bladeLength: number, _bladeWidth: number, _handleWidth: number): void {
        ...
        new Vertex(new Vector3(-1.143185 - this.handleWidth, -0.132427, 0.685987), new Vector2(0.125000, 0.750000)),
        new Vertex(new Vector3(-1.143185 - this.handleWidth, 0.132427, 0.685987), new Vector2(0.625000, 0.000000)),
        new Vertex(new Vector3(-1.143185 - this.handleWidth, -0.132427, 0.220012), new Vector2(0.625000, 1.000000)),
        new Vertex(new Vector3(-1.143185 - this.handleWidth, 0.132427, 0.220012), new Vector2(0.875000, 0.750000)),
        new Vertex(new Vector3(1.143185 + this.handleWidth, -0.132427, 0.685987), new Vector2(0.125000, 0.500000)),
        new Vertex(new Vector3(1.143185 + this.handleWidth, 0.132427, 0.685987), new Vector2(0.375000, 0.250000)),
        new Vertex(new Vector3(1.143185 + this.handleWidth, -0.132427, 0.220012), new Vector2(0.625000, 0.250000)),
        new Vertex(new Vector3(1.143185 + this.handleWidth, 0.132427, 0.220012), new Vector2(0.875000, 0.500000)),
        ...
        new Vertex(new Vector3(-0.334896 - this.bladeWidth, -0.055335, 0.723503), new Vector2(0.375000, 0.000000)),
        new Vertex(new Vector3(-0.334896 - this.bladeWidth, 0.055335, 0.723503), new Vector2(0.375000, 1.000000)),
        new Vertex(new Vector3(-0.334896 - this.bladeWidth, -0.015471, -8.276497 - this.bladeLength), new Vector2(0.125000, 0.750000)),
        new Vertex(new Vector3(-0.334896 - this.bladeWidth, 0.015471, -8.276497 - this.bladeLength), new Vector2(0.625000, 0.000000)),
        new Vertex(new Vector3(0.334896 + this.bladeWidth, -0.055335, 0.723503), new Vector2(0.625000, 1.000000)),
        new Vertex(new Vector3(0.334896 + this.bladeWidth, 0.055335, 0.723503), new Vector2(0.875000, 0.750000)),
        new Vertex(new Vector3(0.334896 + this.bladeWidth, -0.015471, -8.276497 - this.bladeLength), new Vector2(0.125000, 0.500000)),
        new Vertex(new Vector3(0.334896 + this.bladeWidth, 0.015471, -8.276497 - this.bladeLength), new Vector2(0.375000, 0.250000)),
        new Vertex(new Vector3(-0.000000, -0.015471, -9.276497 - this.bladeLength), new Vector2(0.875000, 0.500000)),
        new Vertex(new Vector3(-0.000000, 0.015471, -9.276497 - this.bladeLength), new Vector2(0.625000, 0.250000)),
