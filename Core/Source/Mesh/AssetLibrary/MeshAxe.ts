namespace FudgeCore {
  ...
  export class MeshAxe extends MeshMutable {
    ...
    public create(_shaftLength: number): void {
        ...
        new Vertex(new Vector3(0.228339, -0.063834, 9.293315 + (this.shaftLength)), new Vector2(0.460104, 0.000000)),
        new Vertex(new Vector3(0.364505, -0.200000, 9.293315 + (this.shaftLength)), new Vector2(0.460104, 1.000000)),
        new Vertex(new Vector3(0.364505, 0.200000, 9.293315 + (this.shaftLength)), new Vector2(0.125000, 0.750000)),
        new Vertex(new Vector3(0.228339, 0.063834, 9.293315 + (this.shaftLength)), new Vector2(0.375000, 0.914896)),
        ...
        new Vertex(new Vector3(0.492173, -0.200000, 9.293315 + (this.shaftLength)), new Vector2(0.539896, 1.000000)),
        new Vertex(new Vector3(0.628339, -0.063834, 9.293315 + (this.shaftLength)), new Vector2(0.539896, 0.000000)),
        new Vertex(new Vector3(0.628339, 0.063834, 9.293315 + (this.shaftLength)), new Vector2(0.210104, 0.500000)),
        new Vertex(new Vector3(0.492173, 0.200000, 9.293315 + (this.shaftLength)), new Vector2(0.375000, 0.335104)),
