namespace FudgeCore {
  ...
  export class MeshCarrot extends MeshMutable {
    ...
    public create(_carrotLength: number): void {
        ...
        new Vertex(new Vector3(-0.055910, -0.310822 - _carrotLength, 0.055909), new Vector2(0.376520, 0.331652)),
        new Vertex(new Vector3(-0.055910, 0.132253, 0.055909), new Vector2(0.376520, 0.910921)),
        new Vertex(new Vector3(-0.055910, -0.310822 - _carrotLength, -0.055909), new Vector2(0.229187, 0.331652)),
        new Vertex(new Vector3(-0.055910, 0.132253, -0.055909), new Vector2(0.229187, 0.910921)),
        new Vertex(new Vector3(0.055909, -0.310822 - _carrotLength, 0.055909), new Vector2(0.507484, 0.677385)),
        new Vertex(new Vector3(0.055909, 0.132253, 0.055909), new Vector2(0.507484, 0.100083)),
        new Vertex(new Vector3(0.055909, -0.310822 - _carrotLength, -0.055909), new Vector2(0.081852, 0.331652)),
        new Vertex(new Vector3(0.055909, 0.132253, -0.055909), new Vector2(0.081852, 0.910921)),
        new Vertex(new Vector3(0.000000, -0.310822 - _carrotLength, -0.083864), new Vector2(0.147334, 0.328892)),
        new Vertex(new Vector3(0.000000, 0.132253, -0.083864), new Vector2(0.147334, 0.331652)),
        new Vertex(new Vector3(0.000000, -0.310822 - _carrotLength, 0.083864), new Vector2(0.147334, 0.910921)),
        new Vertex(new Vector3(0.000000, 0.132253, 0.083864), new Vector2(0.147334, 0.908161)),
        new Vertex(new Vector3(-0.083864, -0.310822 - _carrotLength, -0.000000), new Vector2(0.442002, 0.328892)),
        new Vertex(new Vector3(-0.083864, 0.132253, -0.000000), new Vector2(0.589336, 0.677385)),
        new Vertex(new Vector3(0.083864, -0.310822 - _carrotLength, -0.000000), new Vector2(0.589336, 0.100083)),
        ...
        new Vertex(new Vector3(-0.013866, -0.536888 - _carrotLength, 0.013866), new Vector2(0.294668, 0.331652)),
        new Vertex(new Vector3(-0.013866, -0.536888 - _carrotLength, -0.013866), new Vector2(0.294668, 0.910921)),
        new Vertex(new Vector3(0.013866, -0.536888 - _carrotLength, 0.013866), new Vector2(0.294668, 0.908161)),
        new Vertex(new Vector3(0.013866, -0.536888 - _carrotLength, -0.013866), new Vector2(0.442002, 0.672494)),
        new Vertex(new Vector3(0.000000, -0.536888 - _carrotLength, -0.020799), new Vector2(0.000000, 0.331652)),
        new Vertex(new Vector3(0.000000, -0.536888 - _carrotLength, 0.020799), new Vector2(0.442002, 0.095192)),
        new Vertex(new Vector3(-0.020799, -0.536888 - _carrotLength, -0.000000), new Vector2(0.000000, 0.910921)),
        new Vertex(new Vector3(0.020799, -0.536888 - _carrotLength, -0.000000), new Vector2(0.632813, 0.019875)),
        new Vertex(new Vector3(-0.000000, -0.560275 - _carrotLength, -0.000000), new Vector2(0.627687, 0.249928)),
