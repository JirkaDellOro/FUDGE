  ...
  export class MeshShovel extends MeshMutable {
    ...
    public create(_shovelHeadPitch: number,_shaftLength: number): void {
        ...
        this.vertices = new Vertices(
          ...
          new Vertex(new Vector3(-0.030934, -1.150686 - (_shaftLength/2), 0.044907), new Vector2(0.835816, 0.000000)),
          new Vertex(new Vector3(-0.030934, -1.150686 - (_shaftLength/2), -0.014442), new Vector2(0.972773, 0.940304)),
          new Vertex(new Vector3(0.028415, -1.150686 - (_shaftLength/2), 0.044907), new Vector2(0.927121, 0.000000)),
          new Vertex(new Vector3(0.028415, -1.150686 - (_shaftLength/2), -0.014442), new Vector2(0.881469, 0.000000)),
          new Vertex(new Vector3(-0.001259, -1.150686 - (_shaftLength/2), -0.029279), new Vector2(0.904295, 0.942378)),
          new Vertex(new Vector3(-0.001259, -1.150686 - (_shaftLength/2), 0.059745), new Vector2(0.020416, 0.571185)),
          new Vertex(new Vector3(-0.045771, -1.150686 - (_shaftLength/2), 0.015233), new Vector2(0.949947, 0.001011)),
          new Vertex(new Vector3(0.043253, -1.150686 - (_shaftLength/2), 0.015233), new Vector2(0.812990, 0.944035)),
          new Vertex(new Vector3(-0.001259, -1.176415 - (_shaftLength/2), 0.015233), new Vector2(0.000000, 0.530352)),
          new Vertex(new Vector3(0.011584 + (_shovelHeadPitch/1.8), 0.736006, -0.036284), new Vector2(0.949947, 0.942378)),
          new Vertex(new Vector3(0.220234, 0.078110, -0.029279), new Vector2(0.904295, 0.942378)),
          new Vertex(new Vector3(0.011584 + (_shovelHeadPitch/1.8), 0.736006, -0.023657), new Vector2(0.995600, 0.001011)),
          new Vertex(new Vector3(0.220234, 0.078110, 0.059745), new Vector2(0.061249, 0.550769)),
          new Vertex(new Vector3(-0.009801 - (_shovelHeadPitch/1.8), 0.736006, -0.036284), new Vector2(0.040833, 0.509936)),
          new Vertex(new Vector3(-0.218450, 0.078110, -0.029279), new Vector2(0.858642, 0.942378)),
          new Vertex(new Vector3(-0.009801 - + (_shovelHeadPitch/1.8), 0.736006, -0.023657), new Vector2(0.858643, 0.944035)),
          new Vertex(new Vector3(-0.218450, 0.078110, 0.059745), new Vector2(0.015312, 0.509936)),
          new Vertex(new Vector3(0.162918 + (_shovelHeadPitch/2), 0.516707 , -0.014062), new Vector2(0.835816, 0.944019)),
          new Vertex(new Vector3(0.265119, 0.297409, 0.009023), new Vector2(0.045937, 0.571185)),
          new Vertex(new Vector3(0.162918  + (_shovelHeadPitch/2), 0.516707, -0.026689), new Vector2(0.972773, 0.000000)),
          new Vertex(new Vector3(0.265119, 0.297409, -0.003604), new Vector2(0.000000, 0.555873)),
          new Vertex(new Vector3(-0.161135  - (_shovelHeadPitch/2), 0.516707, -0.026689), new Vector2(0.927121, 0.941553)),
          ...
          new Vertex(new Vector3(-0.161135  - (_shovelHeadPitch/2), 0.516707, -0.014062), new Vector2(0.030625, 0.540560)),
