namespace FudgeCore {
  export class MeshDiamond extends MeshMutable {
    ...
    public create(_inflate: number): void {
        ...
        new Vertex(new Vector3(-0.147147, -0.147141, -0.046639 - (_inflate / 2)), new Vector2(0.342731, 0.455063)),
        new Vertex(new Vector3(-0.147147, -0.147153, 0.046600 + (_inflate / 2)), new Vector2(0.455063, 0.657269)),
        new Vertex(new Vector3(-0.147147, 0.147153, -0.046600 - (_inflate / 2)), new Vector2(0.044937, 0.342731)),
        new Vertex(new Vector3(-0.147147, 0.147141, 0.046639 + (_inflate / 2)), new Vector2(0.157269, 0.544937)),
        new Vertex(new Vector3(0.147147, -0.147141, -0.046639 - (_inflate / 2)), new Vector2(0.455063, 0.157269)),
        new Vertex(new Vector3(0.147147, -0.147153, 0.046600 + (_inflate / 2)), new Vector2(0.342731, 0.955063)),
        new Vertex(new Vector3(0.147147, 0.147153, -0.046600 - (_inflate / 2)), new Vector2(0.157269, 0.044937)),
        new Vertex(new Vector3(0.147147, 0.147141, 0.046639  + (_inflate / 2)), new Vector2(0.044937, 0.842731)),
        new Vertex(new Vector3(-0.179392, 0.000007, -0.056836 - (_inflate / 1.8)), new Vector2(0.181526, 0.431526)),
        new Vertex(new Vector3(-0.179392, -0.179392, -0.000024), new Vector2(0.500000, 0.636949)),
        new Vertex(new Vector3(-0.179392, -0.000007, 0.056836  + (_inflate / 1.8)), new Vector2(0.363051, 0.500000)),
        new Vertex(new Vector3(-0.179392, 0.179392, 0.000024), new Vector2(0.318474, 0.568474)),
        new Vertex(new Vector3(-0.000000, 0.179399, -0.056812  - (_inflate / 1.6)), new Vector2(0.136949, 0.500000)),
        new Vertex(new Vector3(-0.000000, 0.179384, 0.056859  + (_inflate / 1.6)), new Vector2(0.000000, 0.363051)),
        new Vertex(new Vector3(0.179392, 0.179392, 0.000024), new Vector2(0.068474, 0.181526)),
        new Vertex(new Vector3(0.179392, 0.000007, -0.056836 - (_inflate / 1.8)), new Vector2(0.068474, 0.681526)),
        new Vertex(new Vector3(0.179392, -0.000007, 0.056836 + (_inflate / 1.8)), new Vector2(0.000000, 0.863051)),
        new Vertex(new Vector3(0.179392, -0.179392, -0.000024), new Vector2(0.136949, 0.000000)),
        new Vertex(new Vector3(-0.000000, -0.179384, -0.056859  - (_inflate / 1.6)), new Vector2(0.318474, 0.068474)),
        new Vertex(new Vector3(-0.000000, -0.179399, 0.056812  + (_inflate / 1.6)), new Vector2(0.181526, 0.931526)),
        ...
        new Vertex(new Vector3(-0.000000, 0.000010, -0.078275  - (_inflate / 1.2)), new Vector2(0.431526, 0.318474)),
        new Vertex(new Vector3(-0.000000, -0.000010, 0.078275  + (_inflate / 1.2)), new Vector2(0.431526, 0.818474)),
