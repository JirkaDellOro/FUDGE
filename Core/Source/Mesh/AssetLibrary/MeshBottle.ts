namespace FudgeCore {
  export class MeshBottle extends MeshMutable {
    ...
    public create(_bottleBodyLength: number, _bottleNeckLength: number): void {
        ...
        new Vertex(new Vector3(0.012992, 0.103499 + this.bottleNeckLength, -0.012992), new Vector2(0.915352, 0.896593)),
        new Vertex(new Vector3(0.017532, 0.036547, -0.017532), new Vector2(0.766071, 0.838747)),
        new Vertex(new Vector3(0.012992, 0.103499 + this.bottleNeckLength, 0.012992), new Vector2(0.109711, 0.778165)),
        new Vertex(new Vector3(0.017532, 0.036547, 0.017532), new Vector2(0.691779, 0.598678)),
        new Vertex(new Vector3(-0.012992, 0.103499 + this.bottleNeckLength, -0.012992), new Vector2(0.909514, 0.747636)),
        new Vertex(new Vector3(-0.017532, 0.036547, -0.017532), new Vector2(0.817778, 0.812894)),
        new Vertex(new Vector3(-0.012992, 0.103499 + this.bottleNeckLength, 0.012992), new Vector2(0.691779, 0.747636)),
        ...
        new Vertex(new Vector3(0.000000, 0.103499 + this.bottleNeckLength, 0.019488), new Vector2(0.857182, 0.896593)),
        new Vertex(new Vector3(0.000000, 0.036547, 0.026297), new Vector2(0.770276, 0.598678)),
        new Vertex(new Vector3(0.000000, 0.103499 + this.bottleNeckLength, -0.019488), new Vector2(0.144599, 0.708390)),
        new Vertex(new Vector3(-0.026297, 0.036547, 0.000000), new Vector2(0.791925, 0.761187)),
        new Vertex(new Vector3(0.019488, 0.103499 + this.bottleNeckLength, 0.000000), new Vector2(0.967683, 0.747636)),
        new Vertex(new Vector3(-0.019488, 0.103499 + this.bottleNeckLength, 0.000000), new Vector2(0.848773, 0.598678)),
        new Vertex(new Vector3(0.026297, 0.036547, 0.000000), new Vector2(0.214374, 0.743278)),
        new Vertex(new Vector3(0.054286, -0.260586 - this.bottleBodyLength, -0.054286), new Vector2(0.726667, 0.598678)),
        ...
        new Vertex(new Vector3(0.054286, -0.260586 - this.bottleBodyLength, 0.054286), new Vector2(0.805164, 0.598678)),
        new Vertex(new Vector3(-0.054286, -0.260586 - this.bottleBodyLength, -0.054286), new Vector2(0.188208, 0.708390)),
        new Vertex(new Vector3(-0.054286, -0.260586 - this.bottleBodyLength, 0.054286), new Vector2(0.947669, 0.896593)),
        new Vertex(new Vector3(0.000000, -0.260586 - this.bottleBodyLength, -0.081430), new Vector2(0.798388, 0.838747)),
        new Vertex(new Vector3(0.000000, -0.260586 - this.bottleBodyLength, 0.081430), new Vector2(0.883660, 0.747636)),
        new Vertex(new Vector3(-0.081430, -0.260586 - this.bottleBodyLength, 0.000000), new Vector2(1.000000, 0.747636)),
        new Vertex(new Vector3(0.081430, -0.260586 - this.bottleBodyLength, 0.000000), new Vector2(0.831329, 0.896593)),
        new Vertex(new Vector3(0.000000, -0.260586 - this.bottleBodyLength, 0.000000), new Vector2(0.759608, 0.761187)),
        new Vertex(new Vector3(0.000000, 0.103499 + this.bottleNeckLength, 0.026297), new Vector2(0.726667, 0.747636)),
        new Vertex(new Vector3(-0.017532, 0.103499 + this.bottleNeckLength, 0.017532), new Vector2(0.648170, 0.598678)),
        new Vertex(new Vector3(0.026297, 0.103499 + this.bottleNeckLength, 0.000000), new Vector2(0.135877, 0.813052)),
        new Vertex(new Vector3(0.017532, 0.103499 + this.bottleNeckLength, 0.017532), new Vector2(0.432114, 0.598679)),
        new Vertex(new Vector3(-0.026297, 0.103499 + this.bottleNeckLength, 0.000000), new Vector2(0.621163, 0.000000)),
        new Vertex(new Vector3(-0.017532, 0.103499 + this.bottleNeckLength, -0.017532), new Vector2(0.621163, 0.598679)),
        new Vertex(new Vector3(0.000000, 0.103499 + this.bottleNeckLength, -0.026297), new Vector2(0.000000, 0.814735)),
        new Vertex(new Vector3(0.017532, 0.103499 + this.bottleNeckLength, -0.017532), new Vector2(0.864227, 0.598679)),
