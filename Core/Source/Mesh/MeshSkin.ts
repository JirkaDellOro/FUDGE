...
namespace FudgeCore {
  ...
  export class MeshSkin extends MeshGLTF {
    ...
    public useRenderBuffers(_shader: ShaderLike, _mtxWorld: Matrix4x4, _mtxProjection: Matrix4x4, _id?: number, _mtxBones?: Matrix4x4[]): RenderBuffers { return null; /* injected by RenderInjector*/ }
