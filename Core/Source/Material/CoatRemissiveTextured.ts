...
namespace FudgeCore {
  ...
  export class CoatRemissiveTextured extends CoatTextured {
    ...
    public constructor(_color: Color = new Color(), _texture: Texture = TextureDefault.texture, _diffuse: number = 1, _specular: number = 0.5, _metallic: number = 0.0, _intensity: number = 0.7) {
