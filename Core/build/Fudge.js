            ...
            if (nDirectional) {
                ...
                if (cmpLights) {
                    ...
                    for (let i = 0; i < n; i++) {
                        ...
                        let direction = Fudge.Matrix4x4.transform(cmpLights[i].getContainer().cmpTransform.world, light.direction);
...
(function (Fudge) {
    ...
    class Matrix4x4 extends Fudge.Mutable {
        ...
        static transform(_matrix, _vector) {
            let result = new Fudge.Vector3();
            let m = _matrix.data;
