...
(function (ControlableCube) {
    ...
    class PivotMarker extends f.Node {
        meshCube = new f.MeshCube("Cube");
        material = new f.Material("SolidRed", f.ShaderUniColor, new f.CoatColored(f.Color.CSS("RED")));
        cmpCube = new f.ComponentMesh(this.meshCube);
        constructor(_name) {
            super(_name);
