...
namespace AudioTest {
    ...
    function init(_event: Event): void {
        ...
        const bodyTwo: ƒ.Node = Scenes.createCompleteMeshNode("Body2", material, new ƒ.MeshCube());
        const mtxBodyTwo: ƒ.Matrix4x4 = bodyTwo.cmpTransform.local;
        ...
        */
        ...
        let audioSourceTwo: string = "Baby.mp3";
