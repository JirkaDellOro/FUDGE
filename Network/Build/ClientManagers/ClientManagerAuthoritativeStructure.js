...
exports.ClientManagerAuthoritativeStructure = void 0;
...
class ClientManagerAuthoritativeStructure {
    ...
    createNegotiationOfferAndSendToPeer = (_userNameForOffer) => {
        try {
    ...
    answerNegotiationOffer = (_remoteIdToAnswerTo) => {
        let ultimateAnswer;
    ...
    sendMessageToServerViaDataChannel = (_messageToSend) => {
        try {
            if (this.remoteEventPeerDataChannel) {
    ...
    sendMessageToSingularPeer = (_messageToSend) => {
