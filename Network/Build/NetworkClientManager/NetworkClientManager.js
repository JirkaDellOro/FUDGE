...
class NetworkClientManager {
    constructor() {
        ...
        this.initiateConnectionByCreatingDataChannelAndPreparingOffer = (_userNameForOffer) => {
        ...
        this.handleReceivedCandidate = async (_receivedIceMessage) => {
        ...
        this.receiveDataChannel = (_event) => {
