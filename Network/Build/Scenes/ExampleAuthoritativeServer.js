...
function broadcastMessageToClients() {
    let stringifiedMessage = JSON.stringify(new PeerMessageSimpleText(networkClient.getLocalClientId(), FudgeNetwork.UiElementHandler.authoritativeServerMessageInput.value, networkClient.localUserName));
