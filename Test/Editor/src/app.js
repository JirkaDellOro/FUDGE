...
(function (UI) {
    ...
    function addCubeNode() {
        ...
        let nodeCubeCoffee = new Fudge.Node("Cube");
        // let nodeCubeCaramel: Fudge.Node = new Fudge.Node("Cube");
        // let nodeCubeCream: Fudge.Node = new Fudge.Node("Cube");
        let cmpMeshCoffee = new Fudge.ComponentMesh(meshCube);
        let cmpMaterialCoffee = new Fudge.ComponentMaterial(mtrCoffee);
        let cmpTransformCoffee = new Fudge.ComponentTransform();
