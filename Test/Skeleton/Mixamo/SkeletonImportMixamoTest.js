...
(function (SkeletonTest) {
    ...
    async function init() {
        ...
        const zylinder = await loadMixamoAnimation();
    ...
    async function loadMixamoAnimation() {
        const loader = await ƒ.GLTFLoader.LOAD("./jumping_down-2.gltf");
        const scene = await loader.getScene();
...
//# sourceMappingURL=SkeletonImportMixamoTest.js.map