...
(function (Turorials_FUDGEPhysics_Lesson1) {
    ...
    function hndKey(_event) {
        ...
        if (_event.code == f.KEYBOARD_CODE.W) {
            ...
            f.Debug.log("Speed", wheelJointFrontRight.motorSpeed);
        }
        ...
        if (_event.code == f.KEYBOARD_CODE.D) {
            ...
            frontSuspensionRight.maxRotor = currentAngle > -maxAngle ? currentAngle-- : currentAngle;
            frontSuspensionRight.minRotor = currentAngle > -maxAngle ? currentAngle-- : currentAngle;
            console.log("left", frontSuspensionLeft.maxRotor);
            console.log("left", frontSuspensionLeft.minRotor);
            console.log(frontSuspensionRight.maxRotor);
            console.log(frontSuspensionRight.minRotor);
        }
