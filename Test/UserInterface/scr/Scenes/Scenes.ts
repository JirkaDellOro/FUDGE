...
namespace ScenesForUi {
    ...
    export function createAxisCross(): ƒ.Node {
        ...
        let cubeRed: ƒ.Node = ScenesForUi.createCompleteMeshNode("Red", mtrRed, meshCube);
        let cubeGreen: ƒ.Node = ScenesForUi.createCompleteMeshNode("Green", mtrGreen, meshCube);
        let cubeBlue: ƒ.Node = ScenesForUi.createCompleteMeshNode("Blue", mtrBlue, meshCube);
    ...
    function createArrow(_name: string, _color: ƒ.Color): ƒ.Node {
        ...
        let shaft: ƒ.Node = ScenesForUi.createCompleteMeshNode("Shaft", material, meshCube);
        let head: ƒ.Node = ScenesForUi.createCompleteMeshNode("Head", material, meshPyramid);
