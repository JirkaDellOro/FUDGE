...
(function (TextureTest) {
    ...
    function init(_event) {
        let coatWhite = new ƒ.CoatColored(ƒ.Color.WHITE);
        ...
        let cmpLightDirectionalRed = new ƒ.ComponentLight(new ƒ.LightDirectional(ƒ.Color.RED));
        cmpLightDirectionalRed.pivot.rotateY(-90);
        branch.addComponent(cmpLightDirectionalRed);
        let cmpLightDirectionalGreen = new ƒ.ComponentLight(new ƒ.LightDirectional(ƒ.Color.GREEN));
        branch.addComponent(cmpLightDirectionalGreen);
        let cmpLightDirectionalBlue = new ƒ.ComponentLight(new ƒ.LightDirectional(ƒ.Color.BLUE));
        cmpLightDirectionalBlue.pivot.rotateY(180);
        branch.addComponent(cmpLightDirectionalBlue);
        let cmpLightDirectionalWhite = new ƒ.ComponentLight(new ƒ.LightDirectional(ƒ.Color.WHITE));
