...
/// <reference types="./Physics/Plugins/oimoJSPlugin" />

namespace FudgeCore {

    declare module "../Babylon.js-master/src/scene" {
     ...
     * @returns a IPhysicsEngine or null if none attached
     */
    Viewport.prototype.getPhysicsEngine = function(): Nullable<IPhysicsEngine> {
     ...
     * @return a boolean indicating if the physics engine was initialized
     */
    Viewport.prototype.enablePhysics = function(gravity: Nullable<Vector3> = null, plugin?: IPhysicsEnginePlugin): boolean {
     ...
     * Disables and disposes the physics engine associated with the scene
     */
    Viewport.prototype.disablePhysicsEngine = function(): void {
        if (!this._physicsEngine) {
            return;
        }
     ...
     * @returns a boolean indicating if there is an active physics engine
     */
    Viewport.prototype.isPhysicsEnabled = function(): boolean {
     ...
     * @param compound defines the compound to delete
     */
    /*Viewport.prototype.deleteCompoundImpostor = function(compound: any): void {
    ...
    /** @hidden */
    Viewport.prototype._advancePhysicsEngineStep = function(step: number) {
        if (this._physicsEngine) {
